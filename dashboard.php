...
<head>
    ...
    <style>
        ...
        .user-row:hover { background-color: rgba(230,239,248,0.5); }
    </style>
</head>
...
<aside class="fixed h-screen w-[280px] left-0 top-0 hidden lg:flex flex-col bg-primary-container shadow-lg border-r border-outline-variant/20 z-50">
    <div class="flex flex-col h-full py-6">
        ...
        <div class="px-4 mt-auto">
            ...
            <button class="w-full flex items-center gap-3 px-4 py-3 text-on-primary/60 hover:bg-white/5 hover:text-on-primary transition-all rounded-lg">
...
<script>
    ...
    function confirmarExclusao(id, nome) {
        ...
        document.getElementById('linkExcluir').href = '?excluir=' + id;
    ...
    document.getElementById('userSearch').addEventListener('input', function () {
        ...
        document.getElementById('userCountDisplay').innerText = visible;
    });

    // Abre modal automaticamente se houver erro no POST
    <?php if ($tipoMensagem === 'erro'): ?>
    window.addEventListener('DOMContentLoaded', () => {
        // Reabrir o modal correto em caso de erro
    });
    <?php endif; ?>
</script>
</body>
